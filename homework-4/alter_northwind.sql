...
ALTER TABLE products ADD CONSTRAINT chk_discontinued_price CHECK (discontinued IN (0, 1))

-- 3. Создать новую таблицу, содержащую все продукты, снятые с продажи (discontinued = 1)
SELECT * INTO prod_discount FROM products WHERE discontinued = 1;
SELECT * FROM prod_discount
